...
/* =====================================================
   FUNÇÕES GLOBAIS PARA BOTÕES DO CARDÁPIO
   Deve ficar no FINAL do script.js
===================================================== */
...
/* =====================================================
   CORREÇÃO FINAL: FUNÇÕES GLOBAIS DO CARDÁPIO
   Colar no FINAL ABSOLUTO do script.js
===================================================== */

window.editarImagemProduto = async function (id) {
  if (typeof usuarioEhAdmin === "function" && !usuarioEhAdmin()) {
    mostrarAviso("Apenas o administrador pode editar imagens.", "erro");
    return;
  }
